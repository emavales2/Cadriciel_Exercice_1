@extends('master')
@section('title', 'Hiking the Andes')
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="mx-auto my-0 text-uppercase">Hiking the Andes</h1>
                        <h2 class="text-white-50 mx-auto mt-2 mb-5">Breathtaking views spanning from Ushuaia to the Colombian cloud forest</h2>
                        <a class="btn btn-primary" href="{{route('trails')}}">Come Explore!</a>
                    </div>
                </div>
            </div>
        </header>
